...
static NSMutableDictionary *receivers = [[NSMutableDictionary alloc] init];
...
void IOSNDKHelperImpl::addNDKReceiver(void *receiver, const char* moduleName)
{
    NSObject *helperInstance = (NSObject *)receiver;
    [receivers setObject:helperInstance forKey:[NSString stringWithUTF8String:moduleName]];
}

#pragma mark -
#pragma mark IOSNDKHelperImpl Methods

void IOSNDKHelperImpl::receiveCPPMessage(json_t *methodName, json_t *methodParams , const char* ndkIdentifier)
{
    //NSObject *receiver = getHelperInstance();
    NSObject *receiver = [receivers objectForKey:[NSString stringWithUTF8String:ndkIdentifier]];
    if (receiver == nil) {
        return;
    }
...
{
    IOSNDKHelperImpl::addNDKReceiver(((void *)receiver), [moduleName UTF8String]);
}
